          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: <Widget>[
                  Expanded(
                    child: buildTextField(_dateOfBirthController, 'Date of Birth', TextInputType.datetime),
                  ),
                  const SizedBox(width: 12.0),
                  Expanded(
                    child: buildTextField(_genderController, 'Gender', TextInputType.text),
                  ),
                ],
              ),
              Row(
                children: <Widget>[
                  Expanded(
                    child: buildTextField(_weightController, 'Weight', TextInputType.number),
                  ),
                  const SizedBox(width: 12.0),
                  Expanded(
                    child: buildTextField(_heightController, 'Height', TextInputType.number),
                  ),
                ],
              ),
              // Continue with the rest of your fields
              buildTextField(_injuryTypeController, 'Injury Type', TextInputType.text),
              buildTextField(_dateOfInjuryController, 'Date of Injury', TextInputType.datetime),
              buildTextField(
